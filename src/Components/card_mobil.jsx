...
const Card = () => {
  return (
    <div className="bg-white w-[330px] h-[460px] md:w-[370px] rounded-xl relative shadow-md">
      <div className="bg-gradient-to-b from-transparent from-20% to-white to-35% rounded-xl w-full h-full absolute">
        <div className="inline-flex bg-slate-500 px-3 rounded-lg opacity-80 m-2">
          <div className="h-3 bg-BlueAvailable rounded-full mt-[6px] mr-1"></div>
        ...
        {/* Container untuk harga dan tombol detail */}
